...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid ml-2">
            ...
            <form method="POST" action="<?php echo base_url('user/updateDataUser/') ?><?php echo $guru[0]->kode ?>">
                <div class="row py-2">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="type" value="guru">
                            <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo $guru[0]->kode ?>">
