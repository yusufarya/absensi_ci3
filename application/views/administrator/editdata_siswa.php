...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid ml-2">
            ...
            <form method="POST" action="<?php echo base_url('user/updateDataSiswa/') ?><?php echo $siswa[0]->kode ?>">
                <div class="row py-2">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="type" value="siswa">
                            <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo $siswa[0]->kode ?>">
                ...
                <a href="<?php echo base_url('datasiswa') ?>" class="btn btn-dark"> <i class="fa fa-chevron-left"></i> Kembali</a>
