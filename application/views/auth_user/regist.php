                ...
                <div class="py-5">
                    <form action="<?php echo base_url('auth_user/register') ?>" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="nip" class="form-control" name="nip" id="nip" placeholder="nip">
                        </div>
                        <div class="mb-2">
                            ...
                            <select name="jenis_kel" id="jenis_kel" class="form-select" aria-label="Default select example">
