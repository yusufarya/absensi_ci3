            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <select name="kelas" id="getkelas" class="form-control mt-2">
                    ...
                    <tbody id="detail">
                        ...
                        foreach ($siswa as $s) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('editdatasiswa_g') . "/" . $s->id ?>" class="btn btn-warning py-0">Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?> -->
                    </tbody>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('auth/register') ?>" method="post">
                <div class="modal-body">
                    <div class="px-3">
                        <div class="mb-2">
                            <input type="hidden" class="form-control" name="type" id="type" value="addSiswa_g">
